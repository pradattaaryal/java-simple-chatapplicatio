...
import java.io.*;
public class kushal implements ActionListener {
    ...
    kushal() {
        ...
        f.add(p1);
		 ///////name tag//////////////
		JLabel Acc=new JLabel("Kushal Adhakari");
    ...
    try {
        ...
        while (true) {
		    ...
		    String sql="INSERT INTO ccc (data)VALUES ('"+msgin+"');";
