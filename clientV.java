...
import java.io.*;
public class clientV implements ActionListener {
    ...
    clientV() {
        ...
        f.add(p1);
		 ///////name tag//////////////
		JLabel Acc=new JLabel("Department E");
    ...
    try {
        ...
        while (true) {
		    ...
		    String sql="INSERT INTO clientv (data)VALUES ('"+msgin+"');";
