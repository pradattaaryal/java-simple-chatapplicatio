...
import java.io.*;
public class clientIV implements ActionListener {
    ...
    clientIV() {
        ...
        f.add(p1);
		 ///////name tag//////////////
		JLabel Acc=new JLabel("Department D");
    ...
    try {
        ...
        while (true) {
		    ...
		    String sql="INSERT INTO clientiv (data)VALUES ('"+msgin+"');";
