...
import java.io.*;
public class clientIII implements ActionListener {
    ...
    clientIII() {
        ...
        f.add(p1);
		 ///////name tag//////////////
		JLabel Acc=new JLabel("Department C");
    ...
    try {
        ...
        while (true) {
		    ...
		    String sql="INSERT INTO clientiii (data)VALUES ('"+msgin+"');";
